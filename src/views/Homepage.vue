      ...
      <div class="row d-flex justify-content-lg-center">
        <div class="col-12 col-lg-12 d-md-flex flex-md-wrap justify-content-md-between">
          ...
          <div class="card border-0 mb-4 flex-lg-row-reverse">
            <img src="https://imgur.com/iD4IZKM.jpg" class="clippy card-img-top position-74 trans" data-aos="fade-left"
              data-aos-offset="400" data-aos-once="true" alt="">
            <div class="card-body p-lg-3 d-lg-flex justify-content-lg-center align-items-lg-center">
          ...
          <div class="card border-0 mb-4 flex-lg-row">
            <img src="https://imgur.com/bM7kc1X.jpg" class="clippy-reverse card-img-top position-90 trans"
              data-aos="fade-right" data-aos-offset="400" data-aos-once="true" alt="">
            <div class="card-body p-lg-3 d-lg-flex justify-content-lg-center align-items-lg-center">
          ...
          <div class="card border-0 flex-lg-row-reverse">
            <img src="https://imgur.com/BPhrxt9.jpg" class="clippy card-img-top trans" data-aos="fade-left"
              data-aos-offset="400" data-aos-once="true" alt="">
            <div class="card-body p-lg-3 d-lg-flex justify-content-lg-center align-items-lg-center">
