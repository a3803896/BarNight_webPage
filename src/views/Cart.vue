                ...
                <div class="col-5">
                    <form action="" class="mb-5">
                        <validation-observer v-slot="{ invalid }">
                            ...
                            <textarea v-model="form.message" name="給賣家的話" id="msgForSeller" cols="30" rows="4"
                                class="form-control mb-2"></textarea>

                            <label for="coupon" class="mb-1 bold">優惠券編號</label>
                            <input v-model="form.coupon" type="text" id="coupon" name="優惠券編號" class="form-control mb-4">

                            <button type="button" :disabled="invalid"
                                class="btn btn-primary w-25 align-self-end float-right mb-5" @click="sendOrder">送出訂單</button>
                        </validation-observer>
                    </form>
                </div>
            </div>
